...
pub fn build(b: *std.Build) !void {
    ...
    exe_mod.addImport("network", network_dep.module("network"));
    exe_mod.addImport("mcl", mcl.module("mcl"));
    exe_mod.addImport("chrono", chrono.module("chrono"));
    exe_mod.addImport("mmc_config", mmc_config.module("mmc-config"));
    exe_mod.linkLibrary(soem.artifact("soem"));
    exe_mod.addIncludePath(soem.path("include"));
    exe_mod.addImport("build.zig.zon", build_zig_zon);
